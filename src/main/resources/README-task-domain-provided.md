...
* Requires Java 8
* Solution can be in Java (preferably Java8 or later) or Groovy
...
Please send your submission to Michael.Reid@redenergy.com.au either in a zip file or online source code sharing services such as GitHub or Bitbucket.
